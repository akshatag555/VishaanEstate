        ...
        <div>
          ...
          <div className='flex flex-col max-w-4xl mx-auto p-3 my-7 gap-4'>
            <p className='text-2xl font-semibold'>
              {listing.name} - ${listing.price}/month
              {/* {listing.offer
          ...
          <p>
            Contact <span className='font-semibold'>{listing.owner.name}</span>{' '}
            for{' '}
          ...
          <Link
          to={`mailto:${listing.owner.email}?subject=Regarding ${listing.name}&body=${message}`}
